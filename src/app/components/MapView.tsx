...
export default function MapView({
  ...
  useEffect(() => {
    ...
    apply(
      ...
      mapInstance.current?.on("click", function (evt) {
        ...
        <div class="relative h-64 w-80 gap-4 bg-white border-1 border-black overflow-hidden">
          ...
          <div class="absolute bottom-0 right-0 z-10 w-full p-2 bg-white border-t-1 border-black flex items-center justify-between">
            ...
            <button id="popup-button" class="rounded-full w-10 h-10 border-1 shrink-0 border-black cursor-pointer hover:scale-110 transition-transform duration-300">
            <img 
  ...
  /*
  // Скрытие/отображение карты при isFirst
  useEffect(() => {
 ...
 */
  ...
  return (
    <div className="relative h-full border-1 border-black w-full overflow-hidden ">
